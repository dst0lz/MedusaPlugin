package eu.thelair.medusa.util;
...
/**
 * NOTICE: This utility was developer as part of AeolusLib. While you can
 * use it for your own projects, You are NOT allowed to delete or move this
 * header comment.
 * Utility:
...
public final class ItemBuilder {
  ...
  public static ItemBuilder create(Material itemType) {
  ...
  /**
   * Clears the {@link ItemStack}s lore and replaces it with the defined
   * String array.
   *
   ...
   *
   * @param data the new int data value (parsed as byte) to set the ItemStack's
   *             durability to.
   * @return the current instance for chainable application.
   * @since 1.0
   */
  ...
  /**
   * Adds and UnsafeEnchantment to the {@link ItemStack} with a defined
   * level int value.
   *
   * @param enchantment the {@link Enchantment} to add to the ItemStack.
   * @param level       the int amount that the Enchantment's
   *                    level will be set to.
   * @return the current instance for chainable application.
   * @since 1.0
   */
  ...
  /**
   * Clears all {@link Enchantment}s from the current {@link ItemStack}
   * then adds the defined array of Enchantments to the ItemStack.
   *
   * @param enchantments the Enchantment array to replace any current
   *                     enchantments applied on the ItemStack.
   ...
   * Clears all {@link Enchantment}s from the current {@link ItemStack}
   * then adds the defined array of Enchantments to the ItemStack
   * with a level int value of 1.
   *
   * @param enchantments the Enchantment array to replace any
   *                     current enchantments applied on the ItemStack.
   * @return the current instance for chainable application.
   * @since 1.0
   */
  ...
  /**
   * Sets the {@link Color} of any LEATHER_ARMOR {@link Material}
   * types of the {@link ItemStack}.
   *
  ...
  /**
   * Clears the {@link Color} of any LEATHER_ARMOR {@link Material}
   * types of the {@link ItemStack}.
   *
   * @return the current instance for chainable application.
   * @since 1.0
  ...
  /**
   * Sets the skullOwner {@link SkullMeta} of the current
   * SKULL_ITEM {@link Material} type {@link ItemStack}.
   *
   * @param name the {@link String} value to set the SkullOwner meta to for the
   *             SKULL_ITEM Material type ItemStack.
   * @return the current instance for chainable application
   * @since 1.0
   */
  public ItemBuilder skullOwner(String name) {
    if (make().getType() == Material.SKULL_ITEM
            && make().getDurability() == (byte) 3) {
